...
export const fetchData = createAsyncThunk('home/fetchData', async () => {
  try {
    const response = await axios.get('https://api.openaq.org/v2/latest?limit=10&page=1&offset=0&sort=desc&radius=1000&country_id=nz&order_by=lastUpdated&dumpRaw=false');
